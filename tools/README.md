...
| `check-freshness.py` | is this red evidence about NOW, or about a world that ended? | 0 no current reds AND something re-ran · 1 current reds exist · **2 established nothing (query failed, or nothing re-ran)** |
